 ...
 *
 * Covers:
 * 1. Fresh bootstrap & provider registration (24 models on default port 28180)
...
test("E2E [1/10] fresh new user bootstrap registers 24 models with zero-latency catalog", async () => {
