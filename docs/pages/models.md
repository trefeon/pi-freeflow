...
| :--- | ---: | ---: | :--- | :--- |
| `muse-spark-1.2-contributor-free` | 1,048,576 | 131,072 | minimal..max | ✅ |
| `mimo-v2.5-free` | 1,048,576 | 131,072 | low, medium, high | ✅ |
| `laguna-s-2.1-free` | 1,048,576 | 131,072 | minimal..max | ❌ |
| `nemotron-3.5-lightning-free` | 1,000,000 | 262,144 | minimal..max | ❌ |
| `nemotron-3-ultra-free` | 1,000,000 | 128,000 | minimal..max | ❌ |
| `hy3-free` | 262,144 | 128,000 | minimal..max | ❌ |
...
| `nemotron-3.5-lightning (Kilo)` | 1,000,000 | 65,536 | OpenRouter | ❌ |
| `nemotron-3-super` | 262,144 | 262,144 | OpenRouter | ❌ |
| `hy3 (Kilo)` | 262,144 | 128,000 | OpenRouter | ❌ |
...
| `lfm-2.5` | 65,536 | 8,192 | OpenRouter | ❌ |
