...
pi-freeflow provides unified access to **32 curated free models** across three upstream providers: **OpenCode Zen**, **KiloCode Gateway**, and **Cline**.
...
| `cline-free/kimi-k3` | 1,000,000 | 131,072 | `minimal`..`max` | ✅ |
