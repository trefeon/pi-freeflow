...
hero:
  name: "pi-freeflow"
  text: "24 free models. Up to 1M context. Zero API keys."
...
features:
  - title: "24 Curated Free Models"
    details: 7 OpenCode Zen + 17 KiloCode Gateway — up to 1M context, 512K output, vision support, no API keys.
