...
hero:
  name: "pi-freeflow"
  text: "34 free models. Up to 1M context. Zero API keys."
...
features:
  - title: "34 Curated Free Models"
    details: 8 OpenCode Zen + 21 KiloCode Gateway + 5 Cline — up to 1M context, 512K output, vision support, no API keys.
