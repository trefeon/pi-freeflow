...
hero:
  name: "pi-freeflow"
  text: "33 free models. Up to 1M context. Zero API keys."
...
features:
  - title: "33 Curated Free Models"
    details: 9 OpenCode Zen + 19 KiloCode Gateway + 5 Cline — up to 1M context, 512K output, vision support, no API keys.
