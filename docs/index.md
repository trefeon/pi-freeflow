...
hero:
  name: "pi-freeflow"
  text: "28 free models. Up to 1M context. Zero API keys."
...
features:
  - title: "28 Curated Free Models"
    details: 8 OpenCode Zen + 20 KiloCode Gateway — up to 1M context, 512K output, vision support, no API keys.
